      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-200 mb-6 leading-relaxed max-w-md">
              Premium seafood sourced directly from Visakhapatnam's pristine waters. 
              We're committed to sustainability, freshness, and supporting coastal communities.
            </p>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-6 text-[#F27C00]">Quick Links</h3>
            <ul className="space-y-3">
              {['Home', 'Products', 'About Us', 'Custom Orders', 'Contact'].map((link) => (
                <li key={link}>
                  <a href="#" className="text-gray-200 hover:text-[#F27C00] transition-colors duration-300">
                    {link}
                  </a>
                </li>
              ))}
          ...
          <div>
            <h3 className="text-lg font-semibold mb-6 text-[#F27C00]">Contact Us</h3>
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                <MapPin className="w-5 h-5 text-[#F27C00] flex-shrink-0" />
                <span className="text-gray-200 text-sm">Visakhapatnam, Andhra Pradesh</span>
              </div>
              <div className="flex items-center space-x-3">
        ...
        <div className="border-t border-white/20 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 text-sm">
            <a href="#" className="text-gray-300 hover:text-[#F27C00] transition-colors duration-300">
              Privacy Policy

Sai Kiran, [6/22/2025 8:58 AM]
</a>
            <a href="#" className="text-gray-300 hover:text-[#F27C00] transition-colors duration-300">
              Terms of Service
            </a>
